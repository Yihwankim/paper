...
df_Gu = pd.read_excel('Gangbuk/Dobonggu.xlsx', sheet_name=None, header=0, skipfooter=0,
                      usecols='C:D, G:H')
...
# 결과값 엑셀로 내보내기
df_Gu.to_excel('Gangbuk_edit1/Dobonggu_edit1.xlsx', sheet_name='edit1', index=False)
