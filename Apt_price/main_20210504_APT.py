...
data1 = pd.read_pickle('data_raw/df_dataset_201707.pkl')

data2 = pd.read_pickle('data_processed/df_dataset_202011.pkl')

data3 = pd.read_pickle('data_processed/df_dataset_202012.pkl')
