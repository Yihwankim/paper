...
#############################################################################################################
# 엑셀 파일 불러오기
df_data = pd.read_excel('Gangbuk_edit3/Eunpyeonggu_edit3.xlsx')

df_Gu = pd.read_excel('Gangbuk_edit3/Eunpyeonggu_edit3.xlsx', usecols='A:P')
...
df.to_excel('Gangbuk_edit4/Eunpyeonggu_edit4.xlsx', sheet_name='edit1', index=True)  # 폴더명은 나중에 바꿔야 함
